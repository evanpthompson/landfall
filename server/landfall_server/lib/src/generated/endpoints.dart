...
import '../companion/companion_endpoint.dart' as _i9;
import '../greetings/greeting_endpoint.dart' as _i10;
import '../layout/layout_endpoint.dart' as _i11;
import '../license/license_endpoint.dart' as _i12;
import '../license/pack_endpoint.dart' as _i13;
import '../photo/photo_endpoint.dart' as _i14;
import '../profile/profile_endpoint.dart' as _i15;
import '../settings/display_settings_endpoint.dart' as _i16;
import '../settings/settings_endpoint.dart' as _i17;
import '../theme/marketplace_endpoint.dart' as _i18;
import '../theme/theme_endpoint.dart' as _i19;
import '../weather/weather_endpoint.dart' as _i20;
import 'package:landfall_server/src/generated/cards/card_push_request.dart'
    as _i21;
import 'package:landfall_server/src/generated/protocol.dart' as _i22;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'companion': _i9.CompanionEndpoint()
        ..initialize(
          server,
          'companion',
          null,
      ...
      'layout': _i11.LayoutEndpoint()
        ..initialize(
          server,
          'layout',
          null,
        ),
      'license': _i12.LicenseEndpoint()
        ..initialize(
          server,
          'license',
          null,
        ),
      'pack': _i13.PackEndpoint()
        ..initialize(
          server,
          'pack',
          null,
        ),
      'photo': _i14.PhotoEndpoint()
        ..initialize(
          server,
          'photo',
          null,
      ...
      'displaySettings': _i16.DisplaySettingsEndpoint()
        ..initialize(
          server,
          'displaySettings',
          null,
      ...
      'marketplace': _i18.MarketplaceEndpoint()
        ..initialize(
          server,
          'marketplace',
          null,
        ),
      'theme': _i19.ThemeEndpoint()
        ..initialize(
          server,
          'theme',
          null,
        ),
      'weather': _i20.WeatherEndpoint()
        ..initialize(
          server,
          'weather',
          null,
        ...
        'pushCard': _i1.MethodConnector(
          ...
          params: {
            ...
            'request': _i1.ParameterDescription(
              name: 'request',
              type: _i1.getType<_i21.CardPushRequest>(),
              nullable: false,
            ),
          },
          call:
    ...
    connectors['companion'] = _i1.EndpointConnector(
      name: 'companion',
      endpoint: endpoints['companion']!,
      methodConnectors: {
        'getOrCreateForDisplay': _i1.MethodConnector(
          name: 'getOrCreateForDisplay',
          params: {
            'displayId': _i1.ParameterDescription(
              name: 'displayId',
              type: _i1.getType<String>(),
              nullable: false,
            ),
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['companion'] as _i9.CompanionEndpoint)
                  .getOrCreateForDisplay(
                    session,
                    params['displayId'],
                  ),
        ),
        'pollForEvents': _i1.MethodConnector(
          name: 'pollForEvents',
          params: {
            'displayId': _i1.ParameterDescription(
              name: 'displayId',
        ...
        'pushAction': _i1.MethodConnector(
          name: 'pushAction',
          params: {
            'displayId': _i1.ParameterDescription(
              name: 'displayId',
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['companion'] as _i9.CompanionEndpoint).pushAction(
                    session,
                    params['displayId'],
                    params['kind'],
                  ),
        ),
        'getCompanionBaseUrl': _i1.MethodConnector(
          name: 'getCompanionBaseUrl',
          params: {},
          call:
              (
                _i1.Session session,
        ...
        'getLayouts': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['layout'] as _i11.LayoutEndpoint)
                  .getLayouts(session),
        ),
        'saveLayout': _i1.MethodConnector(
          ...
          params: {
            'layout': _i1.ParameterDescription(
              name: 'layout',
              type: _i1.getType<_i24.LayoutConfig>(),
              nullable: false,
            ),
          },
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['layout'] as _i11.LayoutEndpoint).saveLayout(
                    session,
                    params['layout'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['layout'] as _i11.LayoutEndpoint).setActiveLayout(
                    session,
                    params['layoutId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['layout'] as _i11.LayoutEndpoint).deleteLayout(
                    session,
                    params['id'],
                  ),
        ),
        ...
        'getLicenseStatus': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['license'] as _i12.LicenseEndpoint)
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['pack'] as _i13.PackEndpoint).listPacks(session),
        ),
        'getOwnedPacks': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['pack'] as _i13.PackEndpoint).getOwnedPacks(
                session,
              ),
        ),
      },
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['photo'] as _i14.PhotoEndpoint).getPhotos(session),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['photo'] as _i14.PhotoEndpoint).getSignedPhotoUrl(
                    session,
                    params['photoId'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['profile'] as _i15.ProfileEndpoint).createProfile(
                    session,
                    params['name'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['profile'] as _i15.ProfileEndpoint).updateProfile(
                    session,
                    params['id'],
                    name: params['name'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['profile'] as _i15.ProfileEndpoint).deleteProfile(
                    session,
                    params['id'],
                  ),
        ),
    ...
    connectors['displaySettings'] = _i1.EndpointConnector(
      name: 'displaySettings',
      endpoint: endpoints['displaySettings']!,
      methodConnectors: {
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['displaySettings'] as _i16.DisplaySettingsEndpoint)
                      .get(
                        session,
                        params['displayId'],
                      ),
        ...
        'save': _i1.MethodConnector(
          ...
          params: {
            'settings': _i1.ParameterDescription(
              name: 'settings',
              type: _i1.getType<_i25.RemoteDisplaySettings>(),
              nullable: false,
            ),
          },
          call:
        ...
        'listMarketplaceThemes': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['marketplace'] as _i18.MarketplaceEndpoint)
        ...
        'listThemes': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['theme'] as _i19.ThemeEndpoint).listThemes(
                session,
              ),
        ),
        'uploadTheme': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['theme'] as _i19.ThemeEndpoint).uploadTheme(
                session,
                params['yaml'],
              ),
        ),
        'importTheme': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['theme'] as _i19.ThemeEndpoint).importTheme(
                session,
                params['url'],
              ),
        ),
        'deleteTheme': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['theme'] as _i19.ThemeEndpoint).deleteTheme(
                session,
                params['id'],
              ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['theme'] as _i19.ThemeEndpoint).previewTheme(
                    session,
                    params['id'],
                  ),
        ),
        'applyTheme': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['theme'] as _i19.ThemeEndpoint).applyTheme(
                session,
                params['themeId'],
        ...
        'getCurrentWeather': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['weather'] as _i20.WeatherEndpoint)
