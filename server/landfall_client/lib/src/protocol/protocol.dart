...
import 'package:landfall_client/src/protocol/cards/card_row.dart' as _i13;
import 'package:landfall_client/src/protocol/agent/api_key.dart' as _i14;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<({_i15.ByteData challenge, _i1.UuidValue id})>()) {
      return (
            challenge: deserialize<_i15.ByteData>(
    ...
    if (t == List<_i16.CalendarEvent>) {
      return (data as List)
              .map((e) => deserialize<_i16.CalendarEvent>(e))
              .toList()
          as T;
    }
    if (t == List<_i17.WeatherForecast>) {
      return (data as List)
              .map((e) => deserialize<_i17.WeatherForecast>(e))
              .toList()
          as T;
    }
    try {
  ...
  Map<String, dynamic>? mapRecordToJson(Record? record) {
    ...
    if (record is ({_i15.ByteData challenge, _i1.UuidValue id})) {
      return {
        "n": {
