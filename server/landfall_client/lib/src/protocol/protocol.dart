...
import 'weather/weather_current.dart' as _i12;
import 'weather/weather_forecast.dart' as _i13;
import 'package:landfall_client/src/protocol/cards/card_row.dart' as _i14;
import 'package:landfall_client/src/protocol/agent/api_key.dart' as _i15;
import 'dart:typed_data' as _i16;
import 'package:landfall_client/src/protocol/calendar/calendar_event.dart'
    as _i17;
import 'package:landfall_client/src/protocol/photo/photo.dart' as _i18;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i12.WeatherCurrent) {
      return _i12.WeatherCurrent.fromJson(data) as T;
    }
    if (t == _i13.WeatherForecast) {
      return _i13.WeatherForecast.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i12.WeatherCurrent?>()) {
      return (data != null ? _i12.WeatherCurrent.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i13.WeatherForecast?>()) {
      return (data != null ? _i13.WeatherForecast.fromJson(data) : null) as T;
    }
    if (t == List<_i14.CardRow>) {
      return (data as List).map((e) => deserialize<_i14.CardRow>(e)).toList()
          as T;
    }
    if (t == List<_i15.ApiKey>) {
      return (data as List).map((e) => deserialize<_i15.ApiKey>(e)).toList()
          as T;
    }
    if (t == _i1.getType<({_i16.ByteData challenge, _i1.UuidValue id})>()) {
      return (
            challenge: deserialize<_i16.ByteData>(
    ...
    if (t == List<_i17.CalendarEvent>) {
      return (data as List)
              .map((e) => deserialize<_i17.CalendarEvent>(e))
              .toList()
          as T;
    }
    if (t == List<_i18.Photo>) {
      return (data as List).map((e) => deserialize<_i18.Photo>(e)).toList()
          as T;
    }
    if (t == List<_i19.WeatherForecast>) {
      return (data as List)
              .map((e) => deserialize<_i19.WeatherForecast>(e))
              .toList()
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i11.Photo => 'Photo',
      _i12.WeatherCurrent => 'WeatherCurrent',
      _i13.WeatherForecast => 'WeatherForecast',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i11.Photo():
        return 'Photo';
      case _i12.WeatherCurrent():
        return 'WeatherCurrent';
      case _i13.WeatherForecast():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'WeatherCurrent') {
      return deserialize<_i12.WeatherCurrent>(data['data']);
    }
    if (dataClassName == 'WeatherForecast') {
      return deserialize<_i13.WeatherForecast>(data['data']);
    }
  ...
  Map<String, dynamic>? mapRecordToJson(Record? record) {
    ...
    if (record is ({_i16.ByteData challenge, _i1.UuidValue id})) {
      return {
        "n": {
